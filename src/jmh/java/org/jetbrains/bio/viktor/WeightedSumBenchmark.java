...
public class WeightedSumBenchmark {
	...
	@Benchmark
	public double dot() {
		return F64ArrayKt.asF64Array(values, 0, arraySize).dot(F64ArrayKt.asF64Array(weights, 0, arraySize));
	}
	...
	public double shortDot() {
		return F64ArrayKt.asF64Array(values, 0, arraySize).dot(shorts);
	}
