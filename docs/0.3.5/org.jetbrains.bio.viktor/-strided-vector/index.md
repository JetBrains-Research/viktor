[0.3.5](../../index.md) / [org.jetbrains.bio.viktor](../index.md) / [StridedVector](.)

# StridedVector

`open class StridedVector` [(source)](https://github.com/JetBrains-Research/viktor/blob/0.3.5/src/main/kotlin/org/jetbrains/bio/viktor/StridedVector.kt#L44)
